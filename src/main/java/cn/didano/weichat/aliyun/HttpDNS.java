...
public class HttpDNS {
    ...
    private static final String SERVER_IP[] = new String[]{"203.107.1.1","203.107.1.65","203.107.1.33","203.107.1.66","203.107.1.34"};
    private static final String ACCOUNT_ID = "131153";
    ...
    class QueryHostTask implements Callable<String> {
        ...
        public String call() {
            ...
            String resolveUrl = "http://" + SERVER_IP[s] + "/" + ACCOUNT_ID + "/d?host=" + hostName;
