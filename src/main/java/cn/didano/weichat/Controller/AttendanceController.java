...
public class AttendanceController {
	...
	/**
	 * 根据用户id,时间查找班级应到人数实到人数未到人数 老师角色
	 * 
	...
	@ResponseBody
	public Out<Hand_classArriveData> notice_findtByUserid(@PathVariable("staff_id") Integer staff_id,
	...
	@ResponseBody
	public Out<Hand_clasStudentArriveAndLeave> studentAttendance_findtByClass(
			@PathVariable("class_id") Integer class_id, @PathVariable("date") String date) {
	...
	@ResponseBody
	public Out<Hand_schoolArriveDate> schoolAttendance_findtByschoolId(@PathVariable("school_id") Integer school_id,
			@PathVariable("date") String date) {
	...
	@ResponseBody
	public Out<OutList<Tb_staff>> staffAttendance_findtBySchool(@PathVariable("school_id") Integer school_id,
			@PathVariable("date") String date) {
	...
	@ResponseBody
	public Out<OutList<Hand_clasStudentArriveAndLeave>> studentAttendance_findtBySchool(
			@PathVariable("school_id") Integer school_id, @PathVariable("date") String date) {
